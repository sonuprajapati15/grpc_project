...
@javax.annotation.Generated(
    ...
    comments = "Source: controller/health_check_status.proto")
...
public final class HealthCheckServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.example.pojo.HealthCheckRequest,
      com.example.pojo.HealthCheckResponse> getCheckMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "check",
      requestType = com.example.pojo.HealthCheckRequest.class,
      responseType = com.example.pojo.HealthCheckResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.example.pojo.HealthCheckRequest,
      com.example.pojo.HealthCheckResponse> getCheckMethod() {
    io.grpc.MethodDescriptor<com.example.pojo.HealthCheckRequest, com.example.pojo.HealthCheckResponse> getCheckMethod;
    if ((getCheckMethod = HealthCheckServiceGrpc.getCheckMethod) == null) {
      synchronized (HealthCheckServiceGrpc.class) {
        if ((getCheckMethod = HealthCheckServiceGrpc.getCheckMethod) == null) {
          HealthCheckServiceGrpc.getCheckMethod = getCheckMethod =
              io.grpc.MethodDescriptor.<com.example.pojo.HealthCheckRequest, com.example.pojo.HealthCheckResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "check"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.example.pojo.HealthCheckRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.example.pojo.HealthCheckResponse.getDefaultInstance()))
              .setSchemaDescriptor(new HealthCheckServiceMethodDescriptorSupplier("check"))
              .build();
        }
      }
    }
  ...
  public static abstract class HealthCheckServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void check(com.example.pojo.HealthCheckRequest request,
        io.grpc.stub.StreamObserver<com.example.pojo.HealthCheckResponse> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                com.example.pojo.HealthCheckRequest,
                com.example.pojo.HealthCheckResponse>(
                  this, METHODID_CHECK)))
          .build();
    }
  }
  ...
  public static final class HealthCheckServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<HealthCheckServiceBlockingStub> {
    ...
    /**
     */
    public com.example.pojo.HealthCheckResponse check(com.example.pojo.HealthCheckRequest request) {
  ...
  public static final class HealthCheckServiceFutureStub extends io.grpc.stub.AbstractFutureStub<HealthCheckServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.example.pojo.HealthCheckResponse> check(
        com.example.pojo.HealthCheckRequest request) {
  ...
  private static final class MethodHandlers<Req, Resp> implements
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_CHECK:
          serviceImpl.check((com.example.pojo.HealthCheckRequest) request,
              (io.grpc.stub.StreamObserver<com.example.pojo.HealthCheckResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class HealthCheckServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.example.pojo.HealthCheckStatus.getDescriptor();
    }
